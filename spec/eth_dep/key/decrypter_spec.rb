describe Eth_DEP::Key::Decrypter do
  ...
  describe ".perform pbkdf2 key" do
    ...
    it "recovers the example pbkdf2 key" do
      result = Eth_DEP::Key::Decrypter.perform key_data, password
  ...
  describe "detects unknown key derivation functions" do
    ...
    it "detects unknown key derivation functions" do
      expect { Eth_DEP::Key::Decrypter.perform key_data, password }.to raise_error(RuntimeError)
    end
  end
