describe Eth_DEP::Address do
  describe "#valid?" do
    context "given an address with a valid checksum" do
      ...
      it "returns true" do
        addresses.each do |address|
          expect(Eth_DEP::Address.new address).to be_valid
        end
      end
    end
    ...
    context "given an address with an invalid checksum" do
      ...
      it "returns false" do
        addresses.each do |address|
          expect(Eth_DEP::Address.new address).not_to be_valid
        end
      end
    end
  ...
  describe "#checksummed" do
    ...
    it "follows EIP55 standard" do
      addresses.each do |plain, checksummed|
        address = Eth_DEP::Address.new(plain)
    ...
    context "given an invalid address" do
      ...
      it "raises an error" do
        expect {
          Eth_DEP::Address.new(bad).checksummed
